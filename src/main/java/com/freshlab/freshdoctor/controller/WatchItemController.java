...
import com.freshlab.freshdoctor.dto.NotificationSettingRequest;
...
public class WatchItemController {
    ...
    @PatchMapping("/{itemCode}/notification")
    public WatchItemResponse updateNotification(
            @CurrentUserId Long userId,
            @PathVariable String itemCode,
            @Valid @RequestBody NotificationSettingRequest request
    ) {
        return watchItemService.updateNotification(userId, itemCode, request.enabled());
    }
}
